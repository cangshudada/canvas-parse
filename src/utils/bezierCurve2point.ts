import { AcrPoint } from '../types/index';
...
class BezierCurve2point {
     ...
     * @param {AcrPoint} p1 起点坐标
     * @param {AcrPoint} p2 终点坐标
     * @returns {AcrPoint[]}
     * @memberof bezierCurve2point
     */
    private oneBezierParse(pointDensity: number, p1: AcrPoint, p2: AcrPoint): AcrPoint[] {
     ...
     * @param {AcrPoint} p1 起点坐标
     * @param {AcrPoint} p2 终点坐标
     * @param {AcrPoint} cp 控制点坐标
     * @returns {AcrPoint[]}
     * @memberof bezierCurve2point
     */
    private twoBezierParse(pointDensity: number, p1: AcrPoint, p2: AcrPoint, cp: AcrPoint): AcrPoint[] {
        const points: AcrPoint[] = [];
     ...
     * @param {AcrPoint} p1 起点坐标
     * @param {AcrPoint} p2 终点坐标
     * @param {AcrPoint} cp1 控制点1坐标
     * @param {AcrPoint} cp2 控制点2坐标
     * @returns {AcrPoint[]}
     * @memberof BezierCurve2point
     */
    private threeBezierParse(pointDensity: number, p1: AcrPoint, p2: AcrPoint, cp1: AcrPoint, cp2: AcrPoint): AcrPoint[] {
        const points: AcrPoint[] = [];
